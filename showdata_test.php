    ...
    <section class="content">
      ...
      <div class="card bg-warning">
        <div class="card-header bg-warning">
          ...
          <!-- <h5>คำชี้แจง</h5> -->
          <h6>แบบประเมินการรู้จักตนเอง หน้า 1/5 ข้อ1 - ข้อ10</h6>
      ...
      <div class="col-md-9 mx-auto">
        ...
        <!-- <div class="form-group">
            ...
            <div class="form-group bg-info">
              <label for="FullName">ชื่อผู้ประเมินการรู้จักตนเอง</label>
              <input type="text" class="form-control" name="FullName" id="FullName" placeholder="FullName" value="<?php echo $name ; ?>">
            </div>
            <div class="card bg-info"><h5>ตัวชี้วัดที่ 1 ด้านการรับรู้ความสามารถของตนเอง</h5></div>
