<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-info">
        <div class="container">
            <a class="navbar-brand" href="index.php">แบบประเมินการรู้จักตนเอง</a>
           ...
           <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">                 
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="../index.php">ตอบแบบประเมินการรู้จักตนเอง <span class="sr-only">(current)</span></a>
                 </li>
                 <!-- <li class="nav-item">
