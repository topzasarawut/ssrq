...
<body>
    ...
    <section id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="pic/ssrq1.png" alt="First slide">
            </div>
            <!-- <div class="carousel-item active">
    ...
    <section class="jumbotron">
        <div class="container text-center">
            <h4 class="display-5">แบบประเมินการรู้จักตนเอง</h4>
                    ...
                    <div class="card-body">
                            ...
                            <div>
                                ...
                                <!-- <div style="text-align: left;"> -->
                                   <button type="submit" class="btn btn-warning btn-sm">เริ่มทำแบบประเมิน</button>
                                </div>
                            </div>
                            </form>
                    </div>
